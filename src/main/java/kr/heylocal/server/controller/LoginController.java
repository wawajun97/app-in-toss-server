...
public class LoginController {
    ...
    public ResponseDto<ResponseUserKeyDto> removeByAccessToken(@RequestHeader("Authorization") String authorization) {
        return loginService.removeByAccessToken(authorization);
    }
